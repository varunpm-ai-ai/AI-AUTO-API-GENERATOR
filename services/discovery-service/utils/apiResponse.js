/**
 * Standardized Response Formatter for Discovery Service
 */
...
class ApiResponse {
  ...
  static error(res, statusCode, message, errorCode = 'DISCOVERY_SERVICE_ERROR', details = null, requestId = null) {
    return res.status(statusCode).json({
      success: false,
      error: {
        code: errorCode,
